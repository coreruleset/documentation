...
* It works with the [crs-toolchain]({{< ref "6-development/6-2-crs-toolchain.md" >}}) for building optimized regular expressions.
...
* It doesn't work with [crs-toolchain]({{< ref "6-development/6-2-crs-toolchain.md" >}}).
