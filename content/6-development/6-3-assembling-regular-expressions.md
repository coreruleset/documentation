...
The files containing regular expression specifications (`.ra` suffix, under `regex-assembly`) contain one regular expression per line. These files are meant to be processed by the [crs-toolchain]({{< ref "6-development/6-2-crs-toolchain.md" >}}).
...
Processors are defined in the [crs-toolchain]({{< ref "6-development/6-2-crs-toolchain.md" >}}).
...
Please see [Include-Except processor]({{< ref "6-development/6-3-assembling-regular-expressions.md#include-except-processor" >}}) for how suffix replacements work.
