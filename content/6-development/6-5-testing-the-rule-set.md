...
If you have your own environment set up, you can configure that for testing. Please [follow these instructions]({{< ref "1-getting-started/1-1-crs-installation.md#installing-a-compatible-waf-engine" >}}) to install the WAF server locally.
